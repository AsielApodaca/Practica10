package mx.edu.itson.practicaautenticacionapodacaa
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) { task ->
                if(task.isSuccessful) {
                    // Registro exitoso, actualiza la interfaz grafica con la información del usuario registrado
                    ...
                    // Si el registro falló, despliega mensaje al usuario
